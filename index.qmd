...
\!\left(\frac{|\mathbf{v}_i(t)|^2}{2}
       ...
       -\kappa\ln\rho\!\left(t,\mathbf{x}^i(t)\right)\right)\mathrm{d}t
$$

::: {style="margin-top: -0.5em;"}
- The action becomes a **finite-dimensional integral** over particle trajectories
- The term $\ln\rho(t,\mathbf{x}^i)\,\,\,$ cannot be evaluated with $\rho_N\,\,\,$ (distributional)
...
- **Pressure / viscous term**: $-\kappa\sum_j w_j\!\left(\tfrac{1}{\rho_i}+\tfrac{1}{\rho_j}\right)\nabla W_h\qquad$ — the standard _SPH pressure force_, here **derived from a variational principle**
- Pair-wise anti-symmetric form ensures **Newton's third law** and exact **linear-momentum conservation**


## Internal energy choices

The pressure force generalizes to an arbitrary internal energy $\mathcal{U}(\rho)\,\,\,$ per unit mass:

$$
\dot{\mathbf{v}}_i = -\frac{\nabla V(\mathbf{x}^i)}{m}
  - \sum_{j=1}^N w_j
    \!\left(\frac{\partial\mathcal{U}}{\partial\rho}(\rho_i)
           +\frac{\partial\mathcal{U}}{\partial\rho}(\rho_j)\right)
    \nabla W_h(\mathbf{x}^i-\mathbf{x}^j)
$$

Two closures are implemented in Struphy:

- **Isothermal:** $\mathcal{U}(\rho) = \kappa\,\ln\rho\,\,\,$, $\;\kappa\,\,\,$ constant
  $\Rightarrow\;\partial_\rho\mathcal{U} = \kappa/\rho\,\,\,$, recovering $\kappa\!\left(\tfrac{1}{\rho_i}+\tfrac{1}{\rho_j}\right)\,\,\,$ in the equation above

- **Polytropic:** $\mathcal{U}(\rho) = \dfrac{\kappa\,\rho^{\gamma-1}}{\gamma-1}\,\,\,$, $\;\kappa\,\,\,$ polytropic constant, $\;\gamma = C_p/C_v\,\,\,$ adiabatic index
  $\Rightarrow\;\partial_\rho\mathcal{U} = \kappa\,\rho^{\gamma-2}$
