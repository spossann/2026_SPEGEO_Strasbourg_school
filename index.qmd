...
Together $h\to 0\,\,$, $N\to\infty\,\,$ with $N h^d \to\infty$ ensures $\rho_{h,N}\to\rho\,\,$.
:::
:::
...
- Evaluated once per particle $i$ and stored as 9 coefficients $-w_i\,\boldsymbol\sigma(\boldsymbol\eta_i)/\rho^{N,h}(\boldsymbol\eta_i)$
:::
